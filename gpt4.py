...
folderList=['Anaheim',"Applewold",'Goffs','Mesic','Sanctuary','Silas']
#'Anaheim',"Applewold",'Goffs'

notlist=['Anaheim','Azusa', 'Goffs', 'Hainesburg', 'Kerrtown', 'Micanopy', 'Mosquito', 'Nemacolin', 'Nicut', 'Nimmons', 'Pettigrew', 'Placida', 'Reyno', 'Roeville', 'Sanctuary', 'Scioto', 'Shelbiana', 'Silas', 'Soldier', 'Spencerville', 'Spotswood', 'Springhill', 'Stilwell', 'Stokes', 'Superior', 'Swormville' ]
...
def generate_score(folder_path, file_name1, file_name2):
    ...
    prompt_part_a = "Rate the spatial relations between two images on a scale of 1 to 10. Based on the given info "
...
for folder in folderList:
    folder_path = './YesBackNoExAuto/' + folder
